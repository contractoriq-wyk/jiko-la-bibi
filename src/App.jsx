...
/* ══════════════════════════════════════════════════════
   GLOBAL L99 STYLES injected once at app root
══════════════════════════════════════════════════════ */
const GLOBAL_CSS = `
  ...
  @keyframes glowPulse{
    0%,100%{box-shadow:0 0 10px rgba(212,175,55,0.2),0 4px 20px rgba(11,31,69,0.15)}
    50%{box-shadow:0 0 22px rgba(212,175,55,0.45),0 6px 30px rgba(11,31,69,0.2)}
  }
  ...
  .l99-card:hover{
    ...
    box-shadow:0 12px 36px rgba(11,31,69,0.18), 0 0 0 1px rgba(212,175,55,0.4) !important;
  }
  ...
  /* ── L99 Shimmer text ── */
  .shimmer-gold{
    background:linear-gradient(135deg,#c8a830 0%,#f7e8a0 35%,#D4AF37 55%,#8B6209 100%);
  ...
  return (
    <div style={{ position:"relative", overflow:"hidden", marginTop:"2.5rem" }}>
      ...
      <div style={{ position:"relative", zIndex:1, padding:"3.5rem 1.5rem 4rem", display:"flex", flexDirection:"column", alignItems:"center", textAlign:"center", gap:"8px" }}>
        <div style={{ fontSize:"11px", letterSpacing:"0.35em", color:"#D4AF37", textTransform:"uppercase", opacity:0.7, fontFamily:"sans-serif" }}>
          Unyamwezini
        </div>
        <h2 className="shimmer-gold" style={{ fontFamily:"'Cinzel Decorative','Cinzel',Georgia,serif", fontSize:"clamp(18px,4.5vw,26px)", fontWeight:900, margin:"0 0 4px", letterSpacing:"0.04em" }}>
          Jiko La Bibi JJJ
        </h2>
        <p style={{ fontFamily:"'Great Vibes',Georgia,serif", fontStyle:"italic", color:"rgba(253,245,228,0.7)", fontSize:"clamp(15px,4vw,20px)", margin:"0 0 1.4rem" }}>
        ...
        <div style={{ display:"flex", flexWrap:"wrap", gap:"14px", justifyContent:"center" }}>
          {[
            ...
            <div key={i} className="l99-btn" style={{
              color:"#FDF5E4", fontFamily:"sans-serif", fontSize:"13px",
              display:"flex", alignItems:"center", gap:"7px",
              background:"rgba(212,175,55,0.08)", border:"1px solid rgba(212,175,55,0.25)",
              borderRadius:"99px", padding:"7px 14px", cursor:"default",
            }}>
...
/* ══════════════════════════════════════════════════════
   MENU EMBED — auto-resizes via postMessage
══════════════════════════════════════════════════════ */
function MenuEmbed() {
    ...
    <div className="page-enter">
      ...
      <div style={{ padding:"2rem 0 0" }}>
        <div style={{ textAlign:"center", marginBottom:"1.2rem", padding:"0 1rem" }}>
          <div style={{ fontSize:"10px", letterSpacing:"0.4em", color:GOLD, textTransform:"uppercase", fontFamily:"sans-serif", marginBottom:"6px", opacity:0.8 }}>
            Unyamwezini Jiko La Bibi JJJ
          </div>
          <h2 className="shimmer-gold l99-section-heading" style={{ fontSize:"clamp(20px,5vw,28px)", fontWeight:900, margin:0 }}>
            Menyu Yetu
          </h2>
    ...
    <div className="page-enter">
      ...
      <div style={{ background:"linear-gradient(160deg,#2d1808,#1a0d03 40%,#0B1F45 100%)", padding:"3.5rem 1.5rem 2.5rem", textAlign:"center", position:"relative", overflow:"hidden" }}>
        ...
        <img src="/logo.png" alt="logo" width={110} height={110}
          style={{ borderRadius:"50%", border:"3px solid "+GOLD, objectFit:"cover", marginBottom:"1rem", boxShadow:"0 0 0 1px #8B6209, 0 0 30px rgba(212,175,55,0.3)", display:"block", margin:"0 auto 1rem" }}
          onError={e => { e.target.style.display="none"; }} />
        <h1 className="shimmer-gold l99-section-heading" style={{ fontSize:"clamp(22px,5vw,30px)", fontWeight:900, margin:"0 0 6px" }}>
          Kuhusu Sisi
        </h1>
        <p style={{ fontFamily:"'Great Vibes',Georgia,serif", color:"rgba(253,245,228,0.7)", fontSize:"clamp(15px,4vw,20px)", margin:0 }}>
          Taste of Tanzania in DAR
        </p>
      </div>
      ...
      <div style={{ maxWidth:"720px", margin:"0 auto", padding:"2rem 1rem" }}>
        ...
        <div className="l99-card" style={{ background:"#FFFFFF", borderRadius:"16px", padding:"2rem", marginBottom:"1.5rem", boxShadow:"0 3px 14px rgba(11,31,69,0.08)", borderLeft:"5px solid "+GOLD }}>
          <h2 className="l99-section-heading" style={{ fontSize:"18px", color:NAVY, margin:"0 0 1rem", display:"flex", alignItems:"center", gap:"8px" }}>
            <span>🏡</span> Hadithi Yetu
          </h2>
