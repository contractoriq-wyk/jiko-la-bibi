        ...
        <div className="grid gap-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-5 rounded-xl border border-gold/30 bg-navy px-4 py-3 text-center">
              <p className="text-[9px] font-bold uppercase tracking-[2px] text-gold/60 mb-2">
                {t("payInfo")} — Lipa Namba
              </p>
              <div className="flex justify-center mb-2">
                <img src="/qr-lipa.jpg" alt="Lipa QR" width={100} height={87}
                  style={{ borderRadius:"6px", border:"1px solid rgba(212,175,55,0.3)", background:"#fff", padding:"3px" }}
                  onError={e => { e.target.style.display="none"; }}
                />
              </div>
              <p className="font-display text-2xl font-black tracking-widest text-gold">
                {business.lipaNamba}
              </p>
